    ...
    return ListTile(
      ...
      trailing: TextButton(
        child: Container(height: 35,width: 90,
            decoration: BoxDecoration(color: Colors.lightBlueAccent,borderRadius: BorderRadius.all(Radius.circular(15.0))),
            child: Center(child: Text('Connect',style: TextStyle(fontSize: 20,color: Colors.black),))),
        onPressed: onTap,
      ),
    );
  }
